...
{{ include "common.images.var.image" (dict "imageRoot" .Values.image "global" .Values.global) }}
{{- end -}}

{{- define "eck-operator.job.image" -}}
{{ include "common.images.var.image" (dict "imageRoot" .Values.image.job "global" .Values.global) }}
{{- end -}}
